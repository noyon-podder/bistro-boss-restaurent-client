  ...
  return (
    <div>
      <section className="md:py-5 md:px-10 lg:h-screen">
        <div
          className={`container px-6 py-24 mx-auto lg:py-32 bg-[url('${bgImage}')] shadow-2xl`}
        >
          <div className="lg:flex lg:flex-row-reverse">
            ...
            <div className="mt-8 lg:w-1/2 lg:mt-0 lg:flex lg:justify-center lg:items-center flex-col border rounded px-3 py-5">
              <h2 className="text-black font-bold text-4xl mb-10">Sign Up</h2>
              <form
                  ...
                  <input
                    ...
                    {...register(
...

                      {
                        ...
                        maxLength: {
                          value: 16,
                          message: "Password must be 16 character or smaller",
                        },
                      }
                    )}
                    type="password"
